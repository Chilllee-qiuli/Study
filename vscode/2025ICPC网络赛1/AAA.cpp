...
int main(){
    ...
    while(t--){
        ...
        // while(!ans.empty()){
        //     team tmpt = ans.top();
        //     cout << tmpt.name << " " << tmpt.ac << " " << tmpt.tme << " " << tmpt.flag << endl;
        //     ans.pop();
        // }
        ...
        for(auto it : unk){
            ...
            if(!ans.empty() && ans.top().name == teamname) {print.push_back(teamname);cout <<"yes: " << teamname << endl;}
            else {
